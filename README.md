...
- Standard `graphql-transport-ws` transport for connection init, subscribe, ping/pong, next/error/complete message decoding, and generated subscription streams.
- AppSync realtime transport for `graphql-ws` connection init, start, stop, ack/keepalive/data/error/complete message decoding, and generated subscription streams.
